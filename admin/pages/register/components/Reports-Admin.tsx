          ...
          {filteredReports.map((report) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                {report.generated ? (
                  <>
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500 transition-colors font-medium">
                      <Eye size={18} />
                      View Report
                    </button>
                  ...
                  <button className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium">
                    No Report Generated
                  </button>
                )}
              </div>
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 right-0 mt-1 border border-gray-300 rounded-lg bg-white shadow-lg z-10">
                <div className="max-h-48 overflow-y-auto">
                  {(courseSearch ? filteredCourses : courses).map((course) => (
                    <button
                      key={course}
                      type="button"
                      onClick={() => {
