    ...
    >
      <section
        className={cn(
          ...
          "justify-center py-3 sm:py-5 lg:py-6",
        )}
      >
        <div
          className={cn(
            "relative grid w-full overflow-hidden rounded-[30px] border",
            "border-[hsl(var(--border)/0.65)] bg-[hsl(var(--card)/0.82)]",
            "shadow-[0_30px_90px_-40px_rgba(0,0,0,0.55)] backdrop-blur-2xl",
