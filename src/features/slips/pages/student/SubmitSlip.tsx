  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        {/* Header */}
        <div className="flex flex-col items-center text-center space-y-4 py-10 border-b border-border/40 bg-gradient-to-b from-muted/40 to-transparent backdrop-blur-sm">
          <Link
            to="/student/slips"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
          ...
          {(datesComplete || categoryComplete) && (
            <Card className="mb-6 border-primary/20 bg-primary/5 animate-fade-in-up">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 space-y-4">
                ...
                <CardContent className="py-4 px-5">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                      Upload supporting documents for your absence claim.
                      Accepted file types: PDF, JPG, PNG, DOC, DOCX (Max 5MB per
                      file)
                    </p>
                  </div>
                </CardContent>
              ...
              <div className="space-y-4">
                <SlipDocumentUploadSection
                  ...
                  onFilesAdd={(files: FileList | null) =>
                    handleFileAdd("excuseLetter", files)
                  }
                ...
                <SlipDocumentUploadSection
                  ...
                  onFilesAdd={(files: FileList | null) =>
                    handleFileAdd("medicalCert", files)
                  }
                  onFileRemove={(index: number) =>
