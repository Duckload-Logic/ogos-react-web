...
import LogMetadataDrawer from "./LogMetadataDrawer";
                  ...
                  <tbody>
                    {logs.map((log: SystemLog) => (
                      <tr
                        ...
                        className="cursor-pointer border-b border-white/10 transition-colors duration-150 hover:bg-white/40 dark:hover:bg-white/[0.03]"
                      >
