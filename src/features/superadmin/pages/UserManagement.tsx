        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={`rounded-xl h-10 border-white/20 backdrop-blur-md ${!roleFilter ? 'bg-white/60' : ''}`}
            >
              All Roles
            </Button>
            <Button
              ...
              className={`rounded-xl h-10 border-white/20 backdrop-blur-md ${roleFilter === 1 ? 'bg-white/60' : ''}`}
            >
              Students
            </Button>
            <Button
              ...
              className={`rounded-xl h-10 border-white/20 backdrop-blur-md ${roleFilter === 2 ? 'bg-white/60' : ''}`}
            >
              Counselors
            </Button>
            <Button
              ...
              className={`rounded-xl h-10 border-white/20 backdrop-blur-md ${roleFilter === 3 ? 'bg-white/60' : ''}`}
            >
              Superadmins
            </Button>
            ...
            <Button
              ...
              className={`rounded-xl h-10 border-white/20 backdrop-blur-md ${roleFilter === 4 ? 'bg-white/60' : ''}`}
            >
              Developers
            </Button>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-1.5 font-bold tracking-tight">
                          <div className={`h-2 w-2 rounded-full ${user.isActive ? 'bg-emerald-500' : 'bg-primary'}`} />
          ...
          <div className="flex items-center justify-between border-t border-white/10 px-6 py-4 backdrop-blur-md">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
                size="sm"
                className="rounded-xl h-9 border-white/20"
                disabled={page === 1}
              ...
              {Array.from({ length: Math.ceil(data.total / 10) }).map((_, i) => (
                <Button
                  key={i}
                  variant={page === i + 1 ? "default" : "outline"}
                  size="sm"
                  className={`rounded-xl h-9 w-9 ${page === i + 1 ? 'shadow-lg' : 'border-white/20'}`}
                  onClick={() => setPage(i + 1)}
                >
                  {i + 1}
                </Button>
