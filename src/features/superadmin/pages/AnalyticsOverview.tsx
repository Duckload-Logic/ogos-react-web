    ...
    <div className="mx-auto w-full max-w-[1700px] space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            className="h-10 rounded-xl border-white/20 backdrop-blur-md"
          >
            <Filter
              size={16}
              className="mr-2"
        ...
        <Card className="col-span-1 min-h-[450px] lg:col-span-3">
          <CardHeader className="flex flex-row items-center justify-between pb-8">
            <div>
              ...
              <p className="mt-1 text-left text-xs font-semibold uppercase text-muted-foreground">
                Evolution of platform engagement
              </p>
            </div>
          </CardHeader>
          <CardContent>
