          ...
          <div className="fixed inset-0 z-[10000]">
            ...
            <div className="relative flex min-h-screen items-center justify-center p-4">
              ...
              >
                ...
                <div className="border-t border-slate-300/90 px-7 py-6 dark:border-white/10">
                  <div className="mb-6 rounded-3xl border border-slate-300 bg-[rgb(241,243,246)] px-6 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] dark:border-white/10 dark:bg-white/[0.045] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                  ...
                  <div className="flex items-center justify-end gap-3">
                    {hasPendingChanges ? (
                      <>
                        <button
                          onClick={handleCancelSettings}
                          className="rounded-2xl border border-slate-300 bg-[rgb(249,250,251)] px-5 py-2.5 text-sm font-medium text-slate-900 shadow-sm transition hover:bg-white hover:shadow-md hover:scale-[1.03] active:scale-95 dark:border-white/10 dark:bg-white/[0.05] dark:text-white dark:hover:bg-white/[0.08]"
                        >
                          Cancel
                        </button>
                        ...
                        <button
                          ...
                          className="rounded-2xl bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-[0_14px_30px_-16px_rgba(220,38,38,0.55)] transition hover:bg-primary/90 hover:shadow-lg hover:scale-[1.03] active:scale-95"
                        >
                          Apply
                        </button>
                      </>
