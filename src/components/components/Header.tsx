...
// Use public path for logo in client/assets/images
      ...
      <div className="bg-primary px-4 py-4 md:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="relative">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white text-black rounded shadow-lg border">
                <Link
                  to="/profile"
          ...
          {/* Logout and Mobile Menu Toggle */}
          <div className="flex items-center gap-2 ml-4">
            <button
              onClick={logout}
              className="p-2 hover:bg-primary-dark rounded transition-colors text-sm md:text-base flex items-center gap-1"
            >
