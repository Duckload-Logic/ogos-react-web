      ...
      {visibleToasts.map((toast, index) => {
        ...
        return (
          <div
            key={index}
            style={{ opacity }}
            className="bg-glass-bg/80 border-glass-border shadow-xl rounded-xl px-5 py-3 text-sm flex items-center gap-3 animate-toast-slide-in-right transition-opacity duration-300"
          >
